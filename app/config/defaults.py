...
DEFAULT_VISION_CODEX_MODEL_NAME = DEFAULT_CODEX_MODEL_NAME

DEFAULT_TEXT_LLM_PROVIDER = DEFAULT_OPENAI_COMPATIBLE_PROVIDER
DEFAULT_TEXT_OPENAI_MODEL_NAME = "Pro/zai-org/GLM-5"
DEFAULT_TEXT_CODEX_MODEL_NAME = DEFAULT_CODEX_MODEL_NAME
...
DEFAULT_LLM_APP_CONFIG = {
    ...
    "vision_codex_model_name": DEFAULT_VISION_CODEX_MODEL_NAME,
